case class Enemy(sprite: ImageSprite, name: String, str: Int = 4, spd: Int = 4, ,hp: Int = 20, armor: Int = 0)
case class Weapon(name: String, dmg: Int, def: Int, wpSpd: Double = 1.0, acc: Double = 1.0)
case class Armor(name: String, def: Int, weight: Double = 0.0)

val goblin = Enemy("Goblin.png","Goblin", 3, 6, 10, 0)
val armoredGob = Enemy("Armored Goblin", 6, 6, 20, 6)
val gobKing = Enemy("Goblin King", 10, 8, 40, 6)
val rat = Enemy("Rat.png", "Rat", 2, 8, 5, 0)
val slime = Enemy("Slime.png", "Slime", 1, 2, 40, 0)
